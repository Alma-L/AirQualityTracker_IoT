...
def main():
    ...
    print("   🚌 Mobile Bus Sensor (sensor-bus-1) - City Bus Route")
    print("   🚴 Wearable Sensor (sensor-wearable-1) - Cyclist / Pedestrian")
    print("   🚁 Drone Sensor (sensor-drone-1) - Aerial / City Monitoring")
